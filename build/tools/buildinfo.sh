...
index1=$(rand 0 1000)*3  
index2=$index1+1
index3=$index1+2  

product=${array[index1]}
...
echo "ro.build.id=$buildId"
echo "ro.build.display.id=$display_id"
echo "ro.build.version.incremental=$user_time"
...
echo "ro.product.model=$buildId"
echo "ro.product.brand=$product"
echo "ro.product.name=$product"
echo "ro.product.device=$product"
echo "ro.product.board=$product"
...
echo "ro.product.manufacturer=$company"
